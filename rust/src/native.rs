...
pub(crate) struct Native {
    ...
    pub set_match_json_body: unsafe extern "C" fn(Handle, c_int),
    pub set_match_multiple: unsafe extern "C" fn(Handle, c_int),
    pub match_header: unsafe extern "C" fn(Handle, *const c_char),
    pub clear_match_headers: unsafe extern "C" fn(Handle),
...
fn load() -> Result<Native, String> {
    ...
    Ok(Native {
        ...
        set_match_json_body: sym!(b"aether_vcr_embed_set_match_json_body\0"),
        set_match_multiple: sym!(b"aether_vcr_embed_set_match_multiple\0"),
        match_header: sym!(b"aether_vcr_embed_match_header\0"),
        clear_match_headers: sym!(b"aether_vcr_embed_clear_match_headers\0"),
