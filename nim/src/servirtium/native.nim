...
proc set_match_multiple*(h: Handle, on: cint)
  {.importc: "aether_vcr_embed_set_match_multiple", cdecl.}
proc match_header*(h: Handle, name: cstring)
  {.importc: "aether_vcr_embed_match_header", cdecl.}
