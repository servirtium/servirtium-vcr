...
The pins below (`AE_PIN=0.650.0`, `AEB_REF=v0.307`) mirror this repo's
...
AE_PIN=0.650.0 AEB_REF=v0.307 aeb_bootstrap        # ensures ae (>= AE_PIN) THEN aeb
```
...
AE_PIN=0.650.0 AEB_REF=v0.307 AEB_FROM_SOURCE=1 bash get.sh
```
