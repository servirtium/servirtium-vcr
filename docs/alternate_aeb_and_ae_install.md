...
The pins below (`AE_PIN=0.675.0`, `AEB_REF=v0.311`) mirror this repo's
...
AE_PIN=0.675.0 AEB_REF=v0.311 aeb_bootstrap        # ensures ae (>= AE_PIN) THEN aeb
```
...
AE_PIN=0.675.0 AEB_REF=v0.311 AEB_FROM_SOURCE=1 bash get.sh
```
