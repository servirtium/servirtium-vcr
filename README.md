...
number** — `0.696.0`, the single ae this repo is *verified* against. (They used
...
file: `curl … -o get.sh && AE_PIN=0.696.0 AEB_REF=v0.319 bash get.sh` — same
result.)
...
curl -fsSL https://raw.githubusercontent.com/aether-lang-dev/aeo/main/get.sh \
  | AE_PIN=0.696.0 AEB_REF=v0.319 AEO_REF=v0.2.3 sh
```
