...
from source (a local/path Swift Package Manager dependency).

```sh
# from the swift binding directory, with libservirtium_vcr-v2.0.0-alpha.1-linux-x86_64.so downloaded:
mkdir -p native
