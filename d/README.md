...
```sh
# from the d binding directory, with libservirtium_vcr-v2.0.0-alpha.1-linux-x86_64.so downloaded:
mkdir -p native
...
```sh
mkdir -p ../core/native
mv libservirtium_vcr-v2.0.0-alpha.1-linux-x86_64.so ../core/native/libservirtium_vcr.so
```
