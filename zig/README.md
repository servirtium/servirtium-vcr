...
from source (a local/path dependency in your `build.zig.zon`).

```sh
# from the zig binding directory, with libservirtium_vcr-v2.0.0-alpha.1-linux-x86_64.so downloaded:
mkdir -p native
